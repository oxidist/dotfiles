...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Iosevka Oxide"
                               :size 14
                               :weight regular
                               :width normal
                               :powerline-scale 1.4)
